...
class ThematicController extends AbstractController
{
        ...
        #[Route('/thematic/new', name: 'new_thematic')]
        ...
        #[Route('/thematic/delete/{id}', name: 'thematic_delete', methods: ['GET', 'POST'])]
        ...
        #[Route('/thematic/edit/{id}', name: 'edit_thematic')]
        ...
        #[Route('/thematic', name: 'app_thematic')]
